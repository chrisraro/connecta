...
export default function AdminAnalyticsPage() {
  ...
  const analytics = useQuery(
    api.adminShop.getShopAnalytics,
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Revenue, orders, and top products from the last 90 days (PHP)
        </p>
      </div>
        ...
        <Card className="bg-card border-border text-foreground">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-emerald-500">
              {formatPHP(analytics.totalRevenue)}
            </div>
        ...
        <Card className="bg-card border-border text-foreground">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              of {analytics.totalOrders} in the last 90 days
            </p>
          </CardContent>
        </Card>
          ...
          {analytics.totalRevenue === 0 ? (
            ...
            <div className="w-full">
                ...
                {analytics.revenueByDay.map((day) => {
                  ...
                  return (
                    <div
                      ...
                      title={
                        day.label + ": " + formatPHP(day.revenue) + " (" + day.orders + " orders)"
                      }
                    >
                      <div
              ...
              <div className="flex justify-between mt-2 text-xs text-muted-foreground">
                ...
                <span>
                  {analytics.revenueByDay[Math.floor(analytics.revenueByDay.length / 2)]?.label}
                </span>
