        ...
        <div className="max-w-5xl mx-auto pb-20">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage and link your physical {CONNECTA.name} cards to your profiles.</p>
                </div>
                ...
                <Card className="border-dashed py-20 bg-muted/20">
                    <CardContent className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-muted-foreground max-w-xs mb-8 font-medium">
                            You haven&apos;t activated any physical {CONNECTA.name} cards yet. Get started by clicking the button above.
                        </p>
