            ...
            {profiles.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {profiles.map((profile) => (
                        <Card key={profile._id} className="overflow-hidden border-border bg-card backdrop-blur-sm hover:border-primary/20 transition-all duration-300 group rounded-[2rem] relative">
                            <div
                            ...
                            <CardFooter className="flex flex-wrap gap-3 pt-0 pb-6 px-6">
                                ...
                                <Dialog>
                                    <DialogTrigger asChild>
                                        <Button variant="secondary" className="flex-1 min-w-[100px] rounded-2xl bg-muted text-foreground hover:bg-muted/80 transition-all h-11">
