...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <main
        className={`flex-1 min-w-0 flex flex-col relative md:pb-0 ${hideMobileChrome ? "" : "pb-48"}`}
      >
        {/* Mobile Header */}
        <MobileHeader />

        <div className="flex-1 min-w-0 p-6 md:p-10 max-w-7xl mx-auto w-full">{children}</div>
