    ...
    <LegalPage title="Terms of Service" lastUpdated={LAST_UPDATED} toc={TOC}>
      ...
      <Section id="accounts" heading="Accounts">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            account; {CONNECTA.name} is not directed at children (see our{" "}
      ...
      <Section id="your-content" heading="Your content">
        <p>
          ...
          content, you grant {CONNECTA.name} a worldwide, non-exclusive, royalty-free
      ...
      <Section id="public-profiles" heading="Public profiles">
        <p>
          A published {CONNECTA.name} profile is publicly accessible to anyone with
      ...
      <Section id="plans-and-limits" heading="Plans & limits">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            up to 100 viewable leads, {CONNECTA.name} branding shown on your profile.
          </li>
          <li>
      ...
      <Section id="billing" heading="Billing & subscriptions">
        ...
        <p>
          ...
          handled by PayRex; {CONNECTA.name} does not store your card or e-wallet
          credentials.
        </p>
      </Section>
      ...
      <Section id="physical-cards" heading="Physical card orders">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            <Callout>
              <strong>Honest gap:</strong> {CONNECTA.name}{" "}does not currently
      ...
      <Section id="termination" heading="Termination">
        <p>
          You may stop using {CONNECTA.name} at any time. A signed-in user can request
      ...
      <Section id="disclaimers" heading="Disclaimers">
        <p>
          {CONNECTA.name}{" "}is provided &quot;as is&quot; and &quot;as available.&quot;
      ...
      <Section id="liability" heading="Limitation of liability">
        <p>
          To the fullest extent permitted under Philippine law, {CONNECTA.name} and
          ...
          the service is limited to the amount you paid to {CONNECTA.name} in the 12
