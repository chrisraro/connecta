# SigmaTap — Marketing Assets

Everything a printer, a designer, or a deck needs to reference SigmaTap's
...
| Name | Hex | Token |
|---|---|---|
| Seal | `#8d2c27` | `--sigmatap-seal` |
| Seal — hover | `#7f1817` | `--sigmatap-seal-hover` |
| Ink | `#201916` | `--sigmatap-ink` |
| Ink — soft | `#5f5652` | `--sigmatap-ink-soft` |
| Paper | `#fcfaf8` | `--sigmatap-paper` |
| Surface | `#f5f1ef` | `--sigmatap-surface` |
| Line | `#e3ddd9` | `--sigmatap-line` |
...
`getComputedStyle(document.documentElement).getPropertyValue('--sigmatap-seal')`
...
3. **Dashboard** (`dashboard.png`) and **profile builder with the inspector
   ...
   (`sigmatap-marketing-demo@sigmatap.example`) and a Clerk *sign-in token*,
