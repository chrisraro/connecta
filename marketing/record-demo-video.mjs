/**
 * Records a product demo video of Herald, end to end, driving the real app.
 *
 ...
 *
 * Output: marketing/video/herald-demo.webm  (VP8, 1440x900, ~52s)
 *
 * FORMAT NOTE
 * -----------
 ...
 *
 *   ffmpeg -i marketing/video/herald-demo.webm \
 *     -c:v libx264 -pix_fmt yuv420p -crf 23 -preset medium \
 *     -movflags +faststart marketing/video/herald-demo.mp4
 *
...
const BASE_URL = process.env.HERALD_BASE_URL ?? "http://localhost:3000";
const OUT_DIR = join(ROOT, "marketing", "video");
const RAW_DIR = join(OUT_DIR, ".raw");
const CHROME =
  process.env.HERALD_CHROME ??
...
const final = join(OUT_DIR, "herald-demo.webm");
