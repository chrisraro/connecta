...
export function DigitalCardModal({
    ...
    const handleDownloadImage = async () => {
        ...
        try {
            ...
            const cardEl = (cardWrapperRef.current.querySelector(".select-none") as HTMLElement) || cardWrapperRef.current;
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[480px] p-4 sm:p-6 bg-background/95 backdrop-blur-2xl border-border rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col items-center justify-center my-4">
                    <div ref={cardWrapperRef} className="w-full flex justify-center p-2 rounded-2xl bg-muted/40 border border-border/50">
                        <DigitalBusinessCard
