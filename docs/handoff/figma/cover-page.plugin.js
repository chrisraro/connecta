...
note.paddingLeft = 28;
note.paddingRight = 28;
note.paddingTop = 24;
note.paddingBottom = 24;
body.appendChild(note);
note.layoutSizingHorizontal = "FILL";

note.appendChild(
  txt(
    "Three things here are billing constraints, not design decisions",
    "Geist",
    "Medium",
    15,
    INK,
...
defects.paddingLeft = 28;
defects.paddingRight = 28;
defects.paddingTop = 24;
defects.paddingBottom = 24;
